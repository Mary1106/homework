...
- отображать маски номеров карт и счетов, записывать логи работы функций
...
- читать JSON-файлы, записывать логи работы функций
- читать csv-файлы
- читать excel-файлы
- конвертировать суммы валютных операций в рубли по текущему курсу
- создавать логи работы
...
Работа функции логируется в mask.log.
...
Работа функции логируется в mask.log в формате: метка времени - название модуля - уровень серьезности: Сообщение о событии или ошибке.
...
#### 13. Функции get_operations_from_csv и get_operations_from_excel
Функции принимают на вход путь до файла с информацией о транзакциях в формате csv или excel:
```
get_operations_from_csv(path_to_csv)
get_operations_from_excel(path_to_excel)
```
Возвращают список словарей или пустые списки, если файлы не существуют или пустые.
...
src\external_api.py..........  83%
src\generators.py............ 100%
src\masks.py................. 100%
src\processing.py............ 100%
src\utils_for_csv_excel.py...  81%
src\utils.py................. 100%
src\widget.py................ 100%
